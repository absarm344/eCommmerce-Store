                ...
                <aside class="filter-sidebar col-lg-2">
                    <div class="sidebar-wrapper">
                        ...
                        <ul class="check-filter-list">
                            ...
                            <li><a href="sportswear.php" class="active">Sportswear</a></li>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div class="product-default inner-quickview inner-icon appear-animate" data-animation-name="fadeIn">
                                            ...
                                            <div class="product-details">
                                                ...
                                                <div class="category-wrap">
                                                    <div class="category-list">
                                                        <a href="demo18-shop.html" class="product-category"><?php echo $subcategory_name; ?></a>
                                                    </div>
                                                </div>
                                                <h3 class="product-title">

                                                    <a href="demo18-product.html"><?php echo $product['name']; ?></a>
                                                </h3>
